...
const profiles = [
  { id: 'blind', name: 'Blind / Low Vision', color: 'hsl(270, 70%, 60%)' },
  { id: 'deaf', name: 'Deaf / Hard of Hearing', color: 'hsl(210, 70%, 60%)' },
  { id: 'dyslexia', name: 'Dyslexia', color: 'hsl(150, 70%, 45%)' },
  { id: 'autism', name: 'Autism Spectrum', color: 'hsl(45, 70%, 55%)' },
  { id: 'adhd', name: 'ADHD', color: 'hsl(0, 70%, 60%)' },
  { id: 'motor', name: 'Motor Disabilities', color: 'hsl(180, 50%, 45%)' },
];
    ...
    <Layout>
      ...
      <section className="container py-16 md:py-24">
        <div className="max-w-3xl mx-auto text-center space-y-6">
          ...
          <p className="text-lg md:text-xl text-muted-foreground readable-width mx-auto animate-fade-up" style={{ animationDelay: '0.1s' }}>
            MorphEDU transforms any educational content into personalized, 
            accessible learning experiences for every type of learner.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center pt-4 animate-fade-up" style={{ animationDelay: '0.2s' }}>
        ...
        <div className="container">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {features.map((feature, index) => (
              <Card 
                key={feature.title} 
                className="border-0 bg-background animate-fade-up"
      ...
      <section className="container py-16 md:py-24">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
          {profiles.map((profile, index) => (
            <div 
              key={profile.id}
              className="p-4 rounded-lg border border-border text-center hover:border-primary/50 transition-colors animate-fade-up"
